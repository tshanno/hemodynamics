...
$(document).ready(function(){
	...
	var ProblemType = Object.freeze({"multiplechoice":0, "calculation":1, "lesson":2});
		...
		$("#feedback").html("<p>Above is a model of the cardiovascular system.  It consists of a heart and a circulation that perfuses five numbered organs or tissues as shown. This system HAS NO REFLEXES and the circulation is assumed to be  noncompliant, but in all other ways it behaves like a normal, human CV system.  The pressure  at the aorta (i.e. the MAP) is maintained constant at 100 mmHg (through autonomic reflexes).   Blood flow (Q) through each  of the organs/tissues is shown, as are their distances (in cm) from the heart.</p> <p> Please select a problem from the list to the left. </p>");
		...
		setImageVisible('problemimage', './images/CirculatoryModel.png', 'visible');
    setImageVisible('logo', './images/Hemodynamics Logo.png', 'visible');
